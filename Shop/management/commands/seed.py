...
from Shop.models.models import (
    ...
    PostFavorite, NewsFavorite, StoryView, GroupChat, GroupMember, GroupMessage,
...
TAGS = [
    ...
    'внж', 'гражданство', 'бизнес', 'доставка', 'транспорт',
    'демо', 'грузинский',
]
...
PLATFORM_NEWS = [
    {
        'title': 'Обновление платформы — избранное прямо из ленты!',
        'text': 'Теперь вы можете добавлять новости и посты в избранное не заходя внутрь — кнопка закладки доступна прямо на карточке в ленте.',
    ...
    },
    {
        ...
        'text': 'Каждый бизнес может пройти верификацию и получить значок «Проверено». Верифицированные бизнесы вызывают больше доверия у клиентов и получают приоритет в выдаче.',
        'img': 'https://picsum.photos/id/3/800/400',
        'tags': ['бизнес', 'рекомендация'],
        'hours_ago': 48,
    },
    {
        'title': 'Летние скидки на VIP-размещение',
        'text': 'До конца июня действует скидка 30% на VIP-размещение. Ваш бизнес будет отображаться в топе каталога и получит больше просмотров.',
...
BUSINESS_NEWS = [
    {
        'biz_idx': 0,
        'title': 'Летняя акция — маникюр со скидкой 20%',
        'text': 'Весь июнь у нас скидка 20% на маникюр + педикюр. Запишитесь через профиль или WhatsApp!',
    ...
    },
    {
        ...
        'text': 'В продаже 5 новых квартир с панорамным видом на Босфор. Район Бешикташ, новостройка 2026 года. Цены от 120 000$.',
    ...
    {
        'biz_idx': 2,
        'title': 'Бесплатный день здоровья — 15 июня',
    ...
    {
        'biz_idx': 5,
        'title': 'Летний сезон туров в Каппадокию открыт',
        'text': 'Сезон 2026 в разгаре! Каппадокия с полётом на шаре — даты на июнь и июль доступны. Раннее бронирование -15%.',
...
ARTICLES = [
    {
        'biz_idx': 0,
        'title': 'Тренды окрашивания волос лето 2026 — что выбрать?',
        'text': 'Летом 2026 в моде натуральные оттенки, плавные переходы и техника "живого" цвета. Рассказываем про самые актуальные тренды: калифорнийский блонд, медные оттенки и «шоколадный латте».\n\nОсобенно популярны техники балаяж и шатуш — они создают эффект выгоревших на солнце прядей. Записывайтесь на бесплатную консультацию!',
    ...
    },
    {
        ...
        'text': 'В 2026 году вступили в силу новые правила получения ВНЖ:\n\n- Минимальная стоимость недвижимости повышена до 200 000$\n- Обязательная медицинская страховка\n- Сроки рассмотрения сокращены до 30 дней\n- Электронный формат подачи документов\n\nМы помогаем с оформлением от А до Я.',
...
BUSINESSES = [
    {
        ...
        'is_verified': True,
        'rating': '4.90',
        'social_instagram': 'beauty_studio_ist',
        'social_whatsapp': '+905551234501',
        'faq': [
            {'question': 'Как записаться?', 'answer': 'Через профиль на сайте, WhatsApp или по телефону.'},
            {'question': 'Есть ли парковка?', 'answer': 'Да, бесплатная парковка рядом.'},
        ],
        'biz_tags': ['красота', 'стамбул'],
        'products': [
        ...
        'stories': [
            {'caption': 'Летняя коллекция цветов — яркие оттенки сезона!', 'url': 'https://picsum.photos/id/64/600/900',  'hours_ago': 1},
            {'caption': 'Скидки до 30% на все процедуры в июне',            'url': 'https://picsum.photos/id/96/600/900',  'hours_ago': 5},
        ...
        'posts': [
            ...
            {'text': 'Летняя коллекция цветов для волос 2026 — яркие тенденции, которые уже у нас. Запись через профиль или WhatsApp.', 'img': 'https://picsum.photos/id/96/800/600', 'type': 'IMAGE', 'hours_ago': 26, 'tags': ['красота', 'новинка']},
        ],
        'tweets': [
            {'text': 'Мы работаем без выходных все лето! Ждём вас с 9:00 до 21:00.', 'hours_ago': 3, 'tags': ['красота', 'стамбул']},
        ],
        'comments': [
    ...
    },
    {
        ...
        'is_verified': True,
        'rating': '4.80',
        'social_telegram': 'istanbul_realty',
        'social_whatsapp': '+905551234502',
        'social_instagram': 'istanbul_realty_group',
        'faq': [
            {'question': 'Можно ли купить квартиру без ВНЖ?', 'answer': 'Да, иностранцы могут покупать недвижимость в Турции без ВНЖ.'},
            {'question': 'Какие дополнительные расходы?', 'answer': 'Налог 4%, нотариус, переводчик — обычно 5-7% от стоимости.'},
            {'question': 'Помогаете ли с ипотекой?', 'answer': 'Да, помогаем оформить ипотеку в турецких банках для иностранцев.'},
        ],
        'biz_tags': ['недвижимость', 'стамбул', 'внж'],
        'products': [
            {'name': 'Студия в центре Стамбула', 'price': '95000',  'currency': 'USD', 'desc': '45 кв.м., 15-й этаж, вид на Босфор, новостройка 2025 г.', 'img': 'https://picsum.photos/id/164/400/300', 'type': 'PRODUCT', 'tags': ['недвижимость', 'стамбул', 'топ']},
        ...
        'tweets': [
            {'text': 'Рынок недвижимости в Стамбуле летом 2026 — цены стабилизировались. Хороший момент для покупки.', 'hours_ago': 8, 'tags': ['недвижимость', 'стамбул']},
            {'text': 'Новое правило: минимальная стоимость для ВНЖ по недвижимости — 200 000$. Подробности у нас в профиле.', 'hours_ago': 50, 'tags': ['внж', 'недвижимость']},
        ],
        'comments': [
    ...
    },
    {
        ...
        'is_verified': True,
        'rating': '4.75',
        'social_whatsapp': '+905551234503',
        'social_telegram': 'turkmed_clinic',
        'faq': [
            {'question': 'Работаете ли вы с переводчиком?', 'answer': 'Да, все консультации проходят с русскоязычным переводчиком.'},
            {'question': 'Принимаете ли страховку?', 'answer': 'Да, работаем со всеми основными страховыми компаниями Турции.'},
        ],
        'biz_tags': ['здоровье', 'анкара'],
        'products': [
        ...
        'stories': [
            {'caption': 'Акция: бесплатная консультация стоматолога в июне', 'url': 'https://picsum.photos/id/342/600/900', 'hours_ago': 6},
            {'caption': 'Новое оборудование — УЗИ нового поколения',         'url': 'https://picsum.photos/id/326/600/900', 'hours_ago': 22},
        ],
        'posts': [
            {'text': 'Бесплатная консультация стоматолога — весь июнь. Запись через профиль. Работаем с переводчиком!', 'img': 'https://picsum.photos/id/342/800/600', 'type': 'IMAGE', 'hours_ago': 7, 'tags': ['здоровье', 'акция', 'анкара']},
            {'text': 'Новое УЗИ-оборудование класса эксперт. Диагностика ещё точнее и быстрее.',                       'img': 'https://picsum.photos/id/237/800/600', 'type': 'IMAGE', 'hours_ago': 48, 'tags': ['здоровье', 'новинка']},
        ],
        'tweets': [
            {'text': 'Напоминаем: летом особенно важно пить достаточно воды и следить за давлением. Берегите себя!', 'hours_ago': 5, 'tags': ['здоровье']},
        ],
        'comments': [
        ...
        'reviews': [
            {'rating': 5, 'pros': 'Переводчик, современное оборудование', 'cons': '', 'text': 'Замечательная клиника. Всё объяснили по-русски, анализы готовы на следующий день.'},
    ...
    },
    {
        ...
        'is_verified': True,
        'rating': '4.60',
        'social_instagram': 'istanbul_language_school',
        'social_telegram': 'istanbul_lang_school',
        'biz_tags': ['образование', 'стамбул'],
        'products': [
        ...
        'stories': [
            {'caption': 'Набор в летние группы турецкого — старт 15 июня', 'url': 'https://picsum.photos/id/20/600/900', 'hours_ago': 2},
            {'caption': 'Наши студенты сдали TOMER — поздравляем!',        'url': 'https://picsum.photos/id/42/600/900', 'hours_ago': 14},
        ],
        'posts': [
            {'text': 'Набор в летние группы турецкого A1 — старт 15 июня. Утренние и вечерние группы. Первый урок бесплатно!', 'img': 'https://picsum.photos/id/20/800/600', 'type': 'IMAGE', 'hours_ago': 3, 'tags': ['образование', 'стамбул']},
            {'text': '5 студентов успешно сдали экзамен TOMER. Интенсивный курс с нами — 95% сдают с первого раза.',           'img': 'https://picsum.photos/id/42/800/600', 'type': 'IMAGE', 'hours_ago': 72, 'tags': ['образование', 'топ']},
        ],
        'tweets': [
            {'text': 'Совет дня: учите по 5 новых турецких слов каждое утро. Через месяц у вас будет 150 слов — это почти A1!', 'hours_ago': 6, 'tags': ['образование']},
            {'text': 'Летние интенсивы: A1 за 4 недели. Каждый день по 3 часа. Осталось 3 места в утренней группе.', 'hours_ago': 30, 'tags': ['образование', 'стамбул']},
        ],
        'comments': [
            'Учусь уже 3 месяца — прогресс заметен! Отличные преподаватели.',
            'Подготовились к TOMER за 2 месяца, сдала с первого раза!',
        ],
        'inquiries': [
        ...
        'reviews': [
            {'rating': 5, 'pros': 'Гибкое расписание, сертификат', 'cons': '',     'text': 'Выучил турецкий с нуля за 6 месяцев. Сдал TOMER с первого раза!'},
            {'rating': 4, 'pros': 'Хорошие преподаватели',         'cons': 'Маленькие группы быстро заполняются', 'text': 'Отличная школа, но запись нужно делать заранее.'},
        ],
    },
    {
        ...
        'is_verified': False,
        'rating': '4.50',
        'social_telegram': 'vostok_finance_tr',
        'biz_tags': ['финансы', 'бизнес'],
        'products': [
        ...
        'tweets': [
            {'text': 'Важно: срок подачи квартальной декларации — до 25 июля. Не пропустите, штрафы выросли!', 'hours_ago': 4, 'tags': ['финансы', 'бизнес']},
        ],
        'comments': [
    ...
    },
    {
        ...
        'is_verified': True,
        'rating': '4.85',
        'social_instagram': 'istanbul_tours_travel',
        'social_whatsapp': '+905551234506',
        'social_youtube': 'istanbul_tours_travel',
        'faq': [
            {'question': 'Включено ли питание в туры?', 'answer': 'Зависит от тура. Каппадокия 3 дня — завтраки включены. Однодневные — обед по желанию.'},
            {'question': 'Есть ли туры для детей?', 'answer': 'Да, семейные программы с активностями для детей от 5 лет.'},
        ],
        'biz_tags': ['туризм', 'анталья', 'стамбул'],
        'products': [
        ...
        'stories': [
            {'caption': 'Полёт на воздушном шаре — незабываемо!',       'url': 'https://picsum.photos/id/318/600/900', 'hours_ago': 4},
        ...
        'posts': [
            ...
            {'text': 'Морская прогулка по Босфору на закате — 2 часа с ужином. Виды на оба континента. Бронируйте сейчас!',         'img': 'https://picsum.photos/id/396/800/600', 'type': 'IMAGE', 'hours_ago': 36, 'tags': ['туризм', 'стамбул']},
        ],
        'tweets': [
            {'text': 'Каппадокия этим летом дешевле чем обычно — курс лиры играет на руку. Успейте забронировать!', 'hours_ago': 10, 'tags': ['туризм', 'скидки']},
        ],
        'comments': [
        ...
        'inquiries': [
            'Есть ли туры в Каппадокию в начале июля? На двоих.',
            'Сколько стоит индивидуальный тур по Стамбулу на 4 человека?',
        ],
        'reviews': [
            {'rating': 5, 'pros': 'Незабываемые впечатления, русский гид', 'cons': '', 'text': 'Летели на шаре в Каппадокии — лучшее что было в жизни! Всё организовано идеально.'},
            {'rating': 5, 'pros': 'Душевная атмосфера, знающий гид',       'cons': '', 'text': 'Тур по Стамбулу с гидом — узнали столько всего о городе.'},
            {'rating': 4, 'pros': 'Отличные маршруты',                     'cons': 'Группы немного большие', 'text': 'Хорошие туры, но в высокий сезон группы бывают большие.'},
        ],
    },
    {
        'username': 'turk_legal',
        ...
        'is_verified': False,
        'rating': '4.70',
        'social_telegram': 'turklegal_ru',
        'social_whatsapp': '+905551234507',
        'faq': [
            {'question': 'Сколько стоит первая консультация?', 'answer': 'Первая 15-минутная консультация бесплатная. Далее — по прайсу.'},
        ],
        'biz_tags': ['юрист', 'внж', 'стамбул'],
        'products': [
        ...
        'stories': [
            {'caption': 'Успешно оформили ВНЖ для 15 клиентов за май', 'url': 'https://picsum.photos/id/160/600/900', 'hours_ago': 8},
        ],
        'posts': [
        ...
        'tweets': [
            {'text': 'С 1 июня 2026 ВНЖ по аренде снова приостановлен для новых заявок. Альтернативы: по недвижимости или рабочий.', 'hours_ago': 12, 'tags': ['юрист', 'внж']},
            {'text': 'Совет: всегда берите нотариально заверенный перевод документов. "Просто перевести" недостаточно для госорганов.', 'hours_ago': 60, 'tags': ['юрист']},
        ],
        'comments': [
        ...
        'reviews': [
            ...
            {'rating': 4, 'pros': 'Профессионализм',                  'cons': 'Дорого', 'text': 'Работа хорошая, но цены чуть выше среднего.'},
        ],
    },
    {
        ...
        'is_verified': False,
        'rating': '4.95',
        'social_whatsapp': '+905551234508',
        'social_instagram': 'bosphorus_kitchen_ist',
        'faq': [
            {'question': 'Какая минимальная сумма заказа?', 'answer': 'Минимальная сумма для бесплатной доставки — 200 TRY.'},
            {'question': 'До какого района доставляете?', 'answer': 'Доставляем по всему Стамбулу. За пределы центра — доплата 50 TRY.'},
        ],
        'biz_tags': ['еда', 'доставка', 'стамбул'],
        'products': [
        ...
        'stories': [
            ...
            {'caption': 'Летнее меню: холодные супы и салаты',               'url': 'https://picsum.photos/id/219/600/900', 'hours_ago': 11},
        ],
        'posts': [
            ...
            {'text': 'Летнее меню: турецкий завтрак на 2 персоны с доставкой. Сыры, оливки, яйца, мёд, варенье, хлеб, чай. 650 TRY.', 'img': 'https://picsum.photos/id/213/800/600', 'type': 'IMAGE', 'hours_ago': 25, 'tags': ['еда', 'новинка']},
        ],
        'tweets': [
            {'text': 'Меню на понедельник: плов, лагман, самса. Заказы через WhatsApp до 16:00!', 'hours_ago': 2, 'tags': ['еда', 'доставка']},
            {'text': 'Летом добавили холодные супы: окрошка и свекольник. Попробуйте!', 'hours_ago': 20, 'tags': ['еда', 'новинка']},
        ],
        'comments': [
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        cnt = {
            ...
            'tweets': 0, 'comments': 0, 'inquiries': 0, 'reviews': 0,
            'tags': 0, 'news': 0, 'articles': 0, 'subscriptions': 0,
            'likes': 0, 'favorites': 0, 'news_favorites': 0,
            'story_views': 0,
        ...
        for data in BUSINESSES:
            ...
            # Твиты (текстовые посты, is_tweet=True)
            if biz_created:
                for tw in data.get('tweets', []):
                    hours_ago = tw.get('hours_ago', 0)
                    created_time = timezone.now() - timedelta(hours=hours_ago)
                    ...
                    Post.objects.filter(pk=tweet.pk).update(created_at=created_time)
                    cnt['tweets'] += 1
                out(f'     Tweets: {len(data.get("tweets", []))}')
        ...
        # ── Теги на продуктах, постах и бизнесах ───────────────────────────
        for data in BUSINESSES:
            try:
            ...
            # Теги бизнеса
            for t_name in data.get('biz_tags', []):
                if t_name in tag_objects:
                    biz.tags.add(tag_objects[t_name])
            ...
            for p_data in data['products']:
                ...
                if p_tags:
                    try:
                        ...
                        pass
            for p_data in data.get('posts', []) + data.get('tweets', []):
                p_tags = p_data.get('tags', [])
                if p_tags:
                    try:
                        ...
                        pass
        out('  [tags] assigned to products, posts and businesses')
        ...
        if regular_users and all_news:
            for i, user in enumerate(regular_users):
                favs_count = min(2, len(all_news))
                for j in range(favs_count):
                    news_item = all_news[(i + j) % len(all_news)]
                    _, created = NewsFavorite.objects.get_or_create(
                        user=user, news=news_item,
                    )
                    if created:
                        cnt['news_favorites'] += 1
        out(f'  [news favorites] {cnt["news_favorites"]} total')
        ...
        # ── Добавляем теги к постам без тегов ────────────────────────────────
        ...
        self._out(self.style.SUCCESS(
            ...
            f'  News Favorites:  {cnt["news_favorites"]}\n'
