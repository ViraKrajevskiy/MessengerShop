        ...
        <div className="bp__grid">
          <div className="bp__main">
            ...
            <section className="bp__card" id="section-about">
              ...
              {/* Social media links */}
              {(biz.social_telegram || biz.social_whatsapp || biz.social_instagram || biz.social_youtube || biz.social_tiktok || biz.social_facebook) && (
                <div className="bp__socials">
                  ...
                  {biz.social_youtube && (
                    <a href={biz.social_youtube.startsWith('http') ? biz.social_youtube : `https://youtube.com/@${biz.social_youtube.replace(/^@/,'')}`} target="_blank" rel="noopener noreferrer" className="bp__social-btn bp__social-btn--youtube" title="YouTube">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
