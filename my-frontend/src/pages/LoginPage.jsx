...
function GoogleLoginSection({ setError }) {
  ...
  return (
    <>
      ...
      <div className="auth-card__socials">
        {!showGoogleRole ? (
          <button type="button" className="auth-social-btn auth-social-btn--google auth-social-btn--full" onClick={() => setShowGoogleRole(true)} disabled={googleLoading}>
          ...
          <div className="auth-google-role">
            ...
            <div className="auth-role-btns">
              <label className={`auth-role-btn ${googleRole === 'USER' ? 'auth-role-btn--active' : ''}`}>
                ...
                <span>{t('reg_roleUser')}</span><small>{t('lookingForServices')}</small>
              </label>
              <label className={`auth-role-btn ${googleRole === 'BUSINESS' ? 'auth-role-btn--active' : ''}`}>
                ...
                <span>{t('reg_roleBusiness')}</span><small>{t('promotingBusiness')}</small>
              </label>
            </div>
            <div className="auth-card__two-btns" style={{ marginTop: 8 }}>
              ...
              <button type="button" className="auth-card__submit auth-card__submit--purple" style={{ marginTop: 0 }} onClick={() => handleGoogleLogin()} disabled={googleLoading}>
      ...
      <div className="auth-page__center">
        <div className="auth-card">
          ...
          <form className="auth-card__form" onSubmit={handleSubmit}>
            ...
            {GOOGLE_CLIENT_ID && <GoogleLoginSection setError={setError} />}
          </form>
