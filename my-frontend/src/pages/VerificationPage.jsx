    ...
    <div className="vp__chat">
            ...
            {editingId === msg.id ? (
              ...
              <>
                ...
                {msg.file && (/\.(jpg|jpeg|png|gif|webp)(\?|$)/i.test(msg.file) ? (
                  ...
                  <a href={msg.file} target="_blank" rel="noopener noreferrer" className="vp__msg-file">
      ...
      {canSend ? (
        <form className="vp__chat-input" onSubmit={onSend}>
          <input ref={fileInputRef} type="file" style={{ display: 'none' }} onChange={handleFileUpload} accept="image/*,.pdf,.doc,.docx" />
          <button
            type="button"
            className="vp__attach-btn"
