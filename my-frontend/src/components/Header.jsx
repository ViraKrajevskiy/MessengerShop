  ...
  return (
    <>
      ...
      <header className="header">
        ...
        <div className="header__top">
          <div className="header__brand">
            ...
            <nav className="header__nav">
              ...
              <button
                className={`header__nav-btn ${location.pathname === '/feed' ? 'header__nav-btn--active' : ''}`}
                onClick={() => go('/feed')}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <button
                className={`header__nav-btn ${location.pathname === '/messenger' ? 'header__nav-btn--active' : ''}`}
              ...
              <div className="header__user-menu" ref={menuRef}>
                ...
                {menuOpen && (
                  <div className="header__dropdown">
                    ...
                    <button className="header__dropdown-item" onClick={() => { navigate('/favorites'); setMenuOpen(false) }}>
        ...
        {/* ── Row 2: Breadcrumb (only on inner pages, not on home) ── */}
        {location.pathname !== '/' && (
        ...
        <nav className="header__mobile-nav">
          ...
          {user && (
            <>
              ...
              <button className="header__mobile-nav-item" onClick={() => go('/favorites')}>
